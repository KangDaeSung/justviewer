 ...
 */
internal class NotiManager(private val context: Context, sessionToken: MediaSessionCompat.Token, notificationListener: PlayerNotificationManager.NotificationListener) {
    ...
    init {
        CLog.e("KDS3393_TEST_NOTI sessionToken = $sessionToken")
    ...
    private inner class DescriptionAdapter(private val controller: MediaControllerCompat) :
        ...
        override fun getCurrentContentText(player: Player) : String {
            return controller.metadata?.description?.subtitle?.toString()?:"[subtitle]"
        }

        override fun getCurrentContentTitle(player: Player) : String {
            return controller.metadata?.description?.title?.toString()?:"[title]"
        }
