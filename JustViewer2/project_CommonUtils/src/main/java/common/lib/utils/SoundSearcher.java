...
public class SoundSearcher {
    ...
    public static boolean matchString(String value, String search){ 
    	return getMatchIndexs(value, search) != -1;
    }
     ...
     * @return index
     * **/
    public static int getMatchIndexs(String value, String search){
        int t = 0; 
        ...
        for(int i = 0 ; i <= seof;i++){ 
            ...
            if(t == slen) {
                return i; //모두 일치한 결과를 찾으면 true를 리턴한다.
            }
        }
        return -1; //일치하는 것을 찾지 못했으면 false를 리턴한다.
    }
}