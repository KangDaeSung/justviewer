...
public class FavoriteList extends ListView {
	...
	private int mListType = Integer.MIN_VALUE;
	...
	private void init() {
		...
		mAdapter = new FavoriteAdapter(getContext(),mDBMgr.getFavoriteCursor(mListType));
	...
	public void reload() {
		mAdapter.changeCursor(mDBMgr.getFavoriteCursor(mListType));
		mAdapter.notifyDataSetChanged();
	}
	...
	public void setType(int type) {
		...
		mListType = type;
		String where = null;
		Cursor cursor = mDBMgr.getFavoriteCursor(type);
		if (cursor != null) {
	...
	public class FavoriteAdapter extends CursorAdapter {
		...
		public void bindView(View view, Context context, Cursor cursor) {
	    	...
	    	if (mListType == KConfig.TYPE_FAVORITE_ALL) {
