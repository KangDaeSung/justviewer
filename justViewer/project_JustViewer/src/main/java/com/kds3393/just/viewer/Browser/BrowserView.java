...
public class BrowserView extends ListView{
	...
	private ArrayList<ZipEntry> mZipEntrys;
	private FileAdapter mAdapter;
	private int mListType = KConfig.TYPE_FAVORITE_ALL;
	...
	public void setZipItem(ArrayList<ZipEntry> datas) {
		mAdapter.clear();
		mZipEntrys = datas;
		if (!isRootPath(rootPath)) {
			mAdapter.add("..");
