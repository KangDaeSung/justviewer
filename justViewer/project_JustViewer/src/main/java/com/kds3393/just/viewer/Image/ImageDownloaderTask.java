...
public class ImageDownloaderTask extends AsyncTask<String, Void, Bitmap> {
	...
	public ImageDownloaderTask(String zipPath, int viewId, ZipEntry key, View view, OnImageDownloadCompleteListener listener) {
		mZipPath = zipPath;
		mEntry = key;
		mViewId = viewId;
	...
	private int mPos = -1;
	public ImageDownloaderTask(String zipPath, int pos, ZipEntry key, View view, int maxWidth, int maxHeight) {
		mZipPath = zipPath;
		mEntry = key;
		mViewId = -1;
		mPos = pos;
